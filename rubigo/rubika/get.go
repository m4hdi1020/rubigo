...
func (b bot) GetMessageAll() (GetResponseChatUpdates, error) {
	values, err := newChatUpdates(b.Auth)
	if err != nil {
		return GetResponseChatUpdates{}, err
	}
...
func (b bot) GetPvMessageAll() ([]getChats, error) {
	...
	for i := range messages.Data.Chats {
		if messages.Data.Chats[i].AbsObject.ObjectGuid[0:1] == "u" {
			messageList = append(messageList, messages.Data.Chats[i])
		}
	}
...
func (b bot) GetGroupMessageAll() ([]getChats, error) {
	...
	var messageList []getChats
	for i := range messages.Data.Chats {
		if messages.Data.Chats[i].AbsObject.ObjectGuid[0:1] == "g" {
...
func (b bot) GetUserMessage(userGuid string) (getChats, error) {
	...
	for i := range messages.Data.Chats {
		if messages.Data.Chats[i].AbsObject.ObjectGuid[0:1] == "u" && messages.Data.Chats[i].LastMessage.AuthorObjectGuid == userGuid {
			return messages.Data.Chats[i], nil
		}
	}
	return getChats{}, nil
}
...
func (b bot) GetGroupMessage(groupGuid string) (getChats, error) {
	...
	for i := range messages.Data.Chats {
		if messages.Data.Chats[i].AbsObject.ObjectGuid[0:1] == "g" && messages.Data.Chats[i].AbsObject.ObjectGuid == groupGuid {
			return messages.Data.Chats[i], nil
		}
	}
	return getChats{}, nil
