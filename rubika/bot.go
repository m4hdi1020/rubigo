...
func newSendFile(text, guid, dcId, fileId, fileName string, size int, mime, accessHashRec string) (string, error) {
	data := sendFile{
		Method: sendMessage,
		Input: struct {
			ObjectGUID string "json:\"object_guid\""
			...
			Mime          string "json:\"mime\""
			AccessHashRec string "json:\"access_hash_rec\""
		}{DcID: dcId, FileID: fileId, Type: "File", FileName: fileName, Size: size, Mime: mime, AccessHashRec: accessHashRec}, Text: text},
		Client: struct {
			AppName    string "json:\"app_name\""
			AppVersion string "json:\"app_version\""
			Platform   string "json:\"platform\""
...
func newSendImage(guid string, caption string, dcId string, id string, fileName string, size int, mime string, width int, height int, accessHashReq string) (string, error) {
	data := imageData{
		Method: sendMessage,
		Input: struct {
			ObjectGUID string "json:\"object_guid\""
			...
			Height        int    "json:\"height\""
			AccessHashRec string "json:\"access_hash_rec\""
		}{DcID: dcId, FileID: id, Type: "Image", FileName: fileName, Size: size, Mime: mime, ThumbInline: "djfsdjfksf", Width: width, Height: height, AccessHashRec: accessHashReq}, Text: caption},
		Client: struct {
			AppName    string "json:\"app_name\""
			AppVersion string "json:\"app_version\""
			Platform   string "json:\"platform\""
...
func newSendInfoFile(fileName string, size int, mime string) (string, error) {
	data := infoSendFile{
