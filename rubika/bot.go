...
func newSendFile(text, guid, dcId, fileId, fileName string, size int, accessHashRec string) (string, error) {
	data := sendFile{
		Method: sendMessage,
		Input: struct {
			ObjectGUID string "json:\"object_guid\""
...
func newSendImage(guid string, caption string, dcId string, id string, fileName string, size int, width int, height int, accessHashReq string) (string, error) {
	data := imageData{
		Method: sendMessage,
		Input: struct {
			ObjectGUID string "json:\"object_guid\""
